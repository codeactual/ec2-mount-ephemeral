...
import (
	...
	cage_errors "github.com/codeactual/ec2-mount-ephemeral/internal/cage/errors"
	cage_trace "github.com/codeactual/ec2-mount-ephemeral/internal/cage/trace"
)
			...
			Errors: []cage_errors.Error{
				{
					...
					Loc: cage_errors.Location{
						...
						Func: "testSingleErrEvent",
						Line: "39",
						Pkg:  "github.com/codeactual/ec2-mount-ephemeral/internal/cage/errors_test",
					},
